    ...
    def train_test_val_split(dataset, train_split=0.8, test_split=0.1, val_split=0.1, shuffle=True, shuffle_size=1000):
        try:
            ...
            if shuffle:
                ...
                val_size = int(val_split*dataset)
...
class data_manupulation:
    ...
    def data_aug_resize(self):
        ...
        return data_aug, data_resizing

    def model_building(self):
        input_shape_ = (32,256,256,3)
        model = tf.keras.models.Sequential([
            self.data_aug_resize(),
            ...
            tf.keras.layers.Conv2D(64,kernel_size=(3,3),activation='relu',),
            tf.keras.layers.MaxPooling2D((2,2)),
            tf.keras.layers.Conv2D(364,kernel_size=(3,3),activation='relu',),
            tf.keras.layers.MaxPooling2D((2,2)),
